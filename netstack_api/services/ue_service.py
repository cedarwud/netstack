...
class UEService:
    ...
    async def record_ue_rtt(
        ...
        try:
            ...
            logger.info("UE RTT 已記錄", imsi=imsi, rtt_ms=rtt_ms, slice_type=slice_type)
    ...
    def _convert_subscriber_to_ue_info(self, subscriber: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                ...
                "last_seen": None,
                "created_at": subscriber.get("created", datetime.now())
            }
            
        except Exception as e:
            logger.error("轉換用戶資料失敗", subscriber_id=subscriber.get("_id"), error=str(e))
            # 回傳最基本的資訊
            return {
